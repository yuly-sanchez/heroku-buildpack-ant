...
testCompile()
{
  ...
  assertCaptured "Installing Apache Ant 1.9.6"
  assertTrue "ant should be executable" "[ -x ${BUILD_DIR}/.buildpack/apache-ant-1.9.6/bin/ant ]"
  
  assertCaptured "executing ${BUILD_DIR}/.buildpack/apache-ant-1.9.6/bin/ant"
